...
def percentage(rollno):
    per = totalmarks(rollno)
    return per  / 500 * 100
...
add()
print(totalmarks(1020))
print(percentage(1020))
print(grade(1020))
print(maximum(1020))
print(minimum(1020))
...
def generate_invoice(product_name, price, tax=10):
